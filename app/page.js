...
const blogs = [
  ...
  },
  {
    ...
    image: '/ep12.jpg',
    summary: 'Nobara proves her strength with her cursed technique in a fierce battle with the cursed spirit of mahito.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e7',
    title: 'Jujutsu Kaisen - Season 1 Episode 7',
    image: '/ep11.jpg',
    summary: 'Gojo removes his blindfold and demonstrates the Six Eyes ability with multiple vision of the hero.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e8',
    title: 'Jujutsu Kaisen - Season 1 Episode 8',
    image: '/ep10.jpg',
    summary: 'A new enemy appears as Mahito begins experimenting on human souls with the assistance of Mahito.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e9',
    title: 'Jujutsu Kaisen - Season 1 Episode 9',
    image: '/ep9.jpg',
    summary: 'Yuji trains in secret under Kento Nanami while recovering from a mission with compelling dynamic.'
  },
  {
  ...
  },
  {
    ...
    image: '/ep7.jpg',
    summary: 'Yuji and Nanami team up to confront Mahito in his twisted domain without exit so they lost Nanami san.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e12',
    title: 'Jujutsu Kaisen - Season 1 Episode 12',
    image: '/ep6.jpg',
    summary: 'Mahito’s domain clashes with Sukuna’s overwhelming presence of power which Yuji couldnt withstand.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e13',
    title: 'Jujutsu Kaisen - Season 1 Episode 13',
    image: '/ep5.jpg',
    summary: 'The group reflects on the battles and prepares for the Kyoto exchange event and outleashes his power.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e14',
    title: 'Jujutsu Kaisen - Season 1 Episode 14',
    image: '/ep4.jpg',
    summary: 'The Kyoto Goodwill Event begins with a fierce powerful clash between schools and ended up massively.'
  },
  {
    slug: 'jujutsu-kaisen-s1-e15',
    title: 'Jujutsu Kaisen - Season 1 Episode 15',
    image: '/ep3.jpg',
    summary: 'Panda and Mechamaru reveal their true forms in an epic confrontation with the cursed spirits.'
  }
];
